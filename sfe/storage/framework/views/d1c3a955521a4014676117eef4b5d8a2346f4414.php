            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo e(route('home')); ?>">
                        <i class="ni ni-tv-2 text-primary"></i> <?php echo e(__('Tableau de bord')); ?>
...
</nav><?php /**PATH C:\Users\Yassine Maadane\sfe\resources\views/layouts/navbars/sidebar.blade.php ENDPATH**/ ?>